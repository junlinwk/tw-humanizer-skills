...
按 preset 光譜（A→E，嚴謹度遞增）排列，外加 Academic 特殊軌道。
每組展示同一情境的 AI 寫法 vs 真實人寫，並標註關鍵指紋。
範例內容為示意用途，目的是展示模式差異，不對應任何特定來源。

**光譜**：A 私人雜記 → B 觀察隨筆 → C 學生手寫風 → D 學生正式校內報告 → E 書信 / 履歷
**特殊軌道**：Academic 學術正式（投稿級別，不在 ABCDE 學生光譜內）
...
## Academic 學術正式（特殊軌道，不屬 ABCDE 學生光譜）
