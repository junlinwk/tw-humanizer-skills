...
按 preset 光譜（A→E）排列。每組展示同一情境的 AI 寫法 vs 真實人寫，並標註關鍵指紋。
...
### ✅ 人寫範例
> 上半年真的爛透了 期中後直接崩 三科被當 室友搬走 我那時候每天就是窩在房間打LOL 後來實在受不了開始去河堤跑步 沒有什麼勵志故事 就是想消耗體力換取睡眠
> -
...
- 想修課程有具體理由（嵌入式 / 作業系統 + 為什麼想修）

**關鍵差異**：套話本身不是 AI 味，**套話之間有真實內容才是人寫**。

---

## D 報告 + 個人聲音 (Report with Voice)

情境：期末課程心得、技術部落格、研究提案
...
>
> 我看到分數的時候第一個想到的不是成績，是那個 82 歲爺爺說「我女兒每次回來都會幫我貼便利貼，但便利貼會被風吹掉」。這門課真正教我的東西，不是書上的設計原則。

### ✅ 人寫範例 2（技術部落格 / debugging 經驗）
> 上週花了三天 debug 一個 Postgres 查詢。最後發現問題不在我寫的 SQL，是 ORM 在我沒指定 ordering 的情況下自動加了 ORDER BY id DESC。
>
...
- 真實 finding（不是想像中的字大小，是日期方向感）
- 自嘲（「我自己也有責任」）
- 結尾不雞湯（個人感悟 / 具體下次行動）

---

## E 學術正式 (Academic Formal)
...
- 具體問題名稱（3-SAT、Clique、Vertex Cover、Hamiltonian Path、Linformer、FlashAttention）
- 「學生」自稱
